...
// ...existing code...
  ...
  // AI Product Listing Integration
  ...
  productForm?.addEventListener('submit', async function(e) {
    e.preventDefault();
    aiResults.innerHTML = '<div class="loading-spinner">Generating suggestions...</div>';
    ...
    try {
      ...
      submitBtn.textContent = 'Generate Product Suggestions';
